...
The server is now hosted, and available at [this base url.](https://precisely-cave-inexpensive-cardiovascular.trycloudflare.com). The frontend can query GeoJSON feaature list at the /destinations endpoint and detailed property data at the /properties/{PK} endpoint. 
